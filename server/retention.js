...
const DELETE_TABLES = ['client_form_files', 'client_forms', 'disclosures', 'consents', 'patient_requests', 'referrals', 'tasks', 'calls', 'overdose_events', 'interventions', 'caloms_records', 'episodes', 'assignments', 'breakglass_events'];
