...
fail=0
for s in desktop review-fixes navigator-flow ux-features local-mode sync-two-way spreadsheets sample-data resource-profiles forms region dates setup static-site qa-retest; do
  echo "=== $s"
