...
function buildRouter() {
  const r = new Router();
  for (const mod of ['setup', 'auth', 'me', 'app', 'users', 'clients', 'assignments', 'interventions', 'calls', 'time', 'resources', 'referrals', 'tasks', 'budget', 'notes', 'consents', 'imports', 'reports', 'admin', 'intake']) {
