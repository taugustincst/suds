...
for s in ${SCRIPTS:-desktop review-fixes navigator-flow navigator-fixes ux-features local-mode sync-two-way spreadsheets sample-data resource-profiles forms region dates setup static-site qa-retest clinical-audit}; do
  echo "=== $s"
