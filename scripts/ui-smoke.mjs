// Browser smoke test of the navigator workflow against a seeded dev server.
// Requires: npm run seed && npm start, plus `npm i -g playwright` (not a project dependency).
// Usage: SUDS_URL=http://127.0.0.1:8080 node scripts/ui-smoke.mjs
import { chromium } from 'playwright';
const base = process.env.SUDS_URL || "http://127.0.0.1:8080";
...
const shot = (n) => page.screenshot({ path: `/tmp/shots/${n}.png` });
