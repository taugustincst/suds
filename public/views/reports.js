...
route('reports', async (r) => {
  ...
  return h('div', {},
    ...
    h('div', { class: 'grid cols-2 mb' },
      h('div', { class: 'card' }, h('h3', {}, 'Interventions by type'), bars(d.interventions.by_type, { link: x => `interventions?type=${x.k}&from=${from}&to=${to}` })), h('div', { class: 'card' }, h('h3', {}, 'Interventions by worker'), bars(d.interventions.by_worker)),
