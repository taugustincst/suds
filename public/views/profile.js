...
route('profile', async (r) => {
  ...
  return h('div', {}, pageHead('My profile'),
    ...
    h('div', { class: 'grid cols-2' },
      ...
      h('div', { class: 'card' }, h('h3', {}, 'Use SUDS on your phone'), h('p', { class: 'small' }, 'Open ', h('code', {}, location.origin), ' on the phone (office Wi-Fi) or scan this code, then add it to the home screen: ', h('b', {}, 'iPhone:'), ' Share → Add to Home Screen. ', h('b', {}, 'Android:'), ' ⋮ → Install app.'), h('div', { class: 'center' }, qrSvg(location.origin + '/', { size: 160 }))),
