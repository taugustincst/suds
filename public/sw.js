...
const VERSION = 'suds-shell-1.7.0';
const SHELL = ['./', 'index.html', 'styles.css', 'main.js', 'app.js', 'qr.js', 'favicon.svg', 'manifest.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png',
  ...['login', 'dashboard', 'clients', 'client', 'interventions', 'calls', 'time', 'resources', 'referrals', 'tasks', 'budget', 'notes', 'imports', 'reports', 'admin', 'profile', 'setup', 'forms', 'dataimport', 'local'].map(v => `views/${v}.js`)];
