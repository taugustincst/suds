...
export async function spreadsheetImportCard() {
  ...
  function renderReview() {
    ...
    const mapTable = h('table', {}, h('thead', {}, h('tr', {}, h('th', {}, 'Column in your file'), h('th', {}, 'Goes into'), h('th', {}, 'First value'))),
    ...
    review.append(...[
      ...
      errRows.length ? h('div', { class: 'card tight mt' }, h('h4', {}, 'Rows that need attention'), table([{ label: 'Row', key: 'n' }, { label: 'Problem', render: r => r.errors.join('; ') }], errRows.slice(0, 50), { wrap: false }), errRows.length > 50 ? h('div', { class: 'small muted' }, `…and ${errRows.length - 50} more`) : null) : null,
  ...
  return h('div', { class: 'card' }, h('h3', {}, 'Import from Excel or CSV'),
