...
module.exports = (r) => {
  crud.build(r, {
    ...
    afterLoad: (ctx, x) => ({ ...withClientName(ctx, x), contact_name: x.contact_name_enc ? decrypt(x.contact_name_enc) : null, phone: x.phone_enc ? decrypt(x.phone_enc) : null, summary: x.summary_enc ? decrypt(x.summary_enc) : null, contact_name_enc: undefined, phone_enc: undefined, summary_enc: undefined }),
