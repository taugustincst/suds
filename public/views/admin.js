  ...
  const T = {
    ...
    async settings() {
      ...
      const f = form([{ type: 'section', label: 'Your programme', collapsible: true, open: true, heading: true },
        ...
        { type: 'section', label: 'Reporting', hint: 'default fund, small cells, naloxone doses', collapsible: true, heading: true },
        ...
        { name: 'small_cell_threshold', label: 'Small-cell threshold (funder, NDP and settlement reports)', type: 'number', min: 2, max: 50, step: 1, value: s.small_cell_threshold || '11', help: 'Every count of people (or of overdoses and reversals) under this is shown as "<N", with another figure hidden beside it wherever it could be worked out from a total, unless a supervisor, administrator or finance runs the report with exact counts for the programme\'s own submission.' },
