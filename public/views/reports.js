...
route('reports', async (r) => {
  ...
  const episodesCard = () => {
    ...
    return h('div', { class: 'card mb', 'data-episodes-report': '1' },
      ...
      h('div', { class: 'grid cols-2' },
        h('div', {}, h('h4', {}, 'Discharges by reason'), bars(s.discharges_by_reason, { list: 'DISCHARGE_REASONS' })),
  ...
  return h('div', {},
    ...
    h('div', { class: 'grid cols-2 mb' },
      h('div', { class: 'card' }, h('h3', {}, 'Interventions by type'), bars(d.interventions.by_type, { list: 'INTERVENTION_TYPES', link: x => `interventions?type=${x.k}&from=${from}&to=${to}` })), h('div', { class: 'card' }, h('h3', {}, 'Interventions by worker'), bars(d.interventions.by_worker)),
    ...
    seesEpisodes || can('export:identified') ? h('div', { class: 'card mb', 'data-state-reporting-link': '1' }, h('div', { class: 'card-head' }, h('h3', {}, 'State reporting & county EHR hand-off'), h('a', { class: 'btn sm primary', href: '#/caloms' }, 'Open')),
