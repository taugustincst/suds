...
const VERSION = 'suds-shell-1.12.4';
...
const SHELL = ['./', 'index.html', 'local-boot.js', 'styles.css', 'main.js', 'app.js', 'qr.js', 'get-app.html', 'get-app.js', 'accessibility.html', 'accessibility.js', 'favicon.svg', 'manifest.webmanifest', 'manifest-local.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png',
