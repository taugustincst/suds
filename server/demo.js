...
const TABLES = ['client_form_files', 'client_forms', 'form_templates', 'expenditures', 'disclosures', 'consents', 'note_addenda', 'notes', 'tasks', 'referrals', 'time_entries', 'calls', 'interventions', 'assignments', 'clients', 'budget_lines', 'funding_sources', 'resource_photos', 'resources'];
const SYNCED = new Set(['client_form_files', 'client_forms', 'form_templates', 'expenditures', 'disclosures', 'consents', 'note_addenda', 'notes', 'tasks', 'referrals', 'time_entries', 'calls', 'interventions', 'assignments', 'clients', 'budget_lines', 'funding_sources', 'resource_photos', 'resources']);
