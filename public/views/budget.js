...
route('budget', async (r) => {
  ...
  return h('div', {},
    pageHead('Funding & spending', can('budget:write') ? h('button', { class: 'btn primary', onClick: () => openExpenditureForm(null, { onDone: refresh }) }, '+ Record expenditure') : null, can('budget:write') ? h('button', { class: 'btn', onClick: () => openFundForm(null, refresh) }, '+ Funding source') : null, h('button', { class: 'btn', onClick: () => downloadCsv('/api/reports/export/expenditures?from=2000-01-01') }, 'Export CSV')),
