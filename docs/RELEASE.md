...
- [ ] `npm test` passes and the browser suite (`scripts/ui/run-all.sh`, twenty scripts including the first-run wizard, local mode, sync and the static build) exits 0
